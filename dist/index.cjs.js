...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#ef9be7", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#f1d5f8", tertiary: "#EFF4F5", text: "#a3659f", textDisabled: "#BDC2C4", textSubtle: "#b65bb9", borderColor: "#a3659f", card: "#fcb8f8", gradients: {
